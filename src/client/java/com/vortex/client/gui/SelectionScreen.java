...
public abstract class SelectionScreen extends Screen {
    ...
    private void drawHeader(GuiGraphics ctx, int x, int y, int w, int accent, Theme t) {
        ...
        ctx.drawString(this.font, Component.literal(title),
    ...
    private void drawGrid(GuiGraphics ctx, int x, int y, int w, int h,
        ...
        for (Entry e : list) {
            ...
            try {
                ctx.renderItem(e.icon, cx + 8, cy + 7);
