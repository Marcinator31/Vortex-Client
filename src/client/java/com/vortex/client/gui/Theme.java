...
public final class Theme {
    ...
    public final ColorSetting accent      = new ColorSetting("Accent",        0xFF4C8BF5); // blau
    public final ColorSetting background   = new ColorSetting("Background",   0xCC1A1A1E); // dunkel, halbtransparent
    ...
    public final ColorSetting textDim       = new ColorSetting("Text Dimmed",  0xFFB0B0B8);
    public final ColorSetting enabledColor = new ColorSetting("Enabled Color",      0xFF55FF7A); // gruen
    public final ColorSetting disabledColor = new ColorSetting("Disabled Color",     0xFF55585F); // grau
     ...
     */
    public final com.vortex.client.core.setting.NumberSetting opacity =
            new com.vortex.client.core.setting.NumberSetting(
