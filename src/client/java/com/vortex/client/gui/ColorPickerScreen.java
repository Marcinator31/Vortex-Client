...
public class ColorPickerScreen extends Screen {
    ...
    public void render(GuiGraphics ctx, int mouseX, int mouseY, float delta) {
        ...
        ctx.drawString(this.font, Component.literal(setting.getName()),
        ...
        // --- Hex-Eingabe ---
        int hy = wy + WIN_H - 33;
        ctx.drawString(this.font, Component.literal("Hex"),
        ...
        ctx.drawString(this.font, Component.literal(done),
     ...
     */
    private void drawSatBriField(GuiGraphics ctx, int x, int y, int w, int h) {
        int step = 2;
