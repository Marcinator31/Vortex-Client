...
public class ThemeScreen extends Screen {
    ...
    public void render(GuiGraphics ctx, int mouseX, int mouseY, float delta) {
        ...
        // Farbstimmungen
        ctx.drawString(this.font, Component.literal("Accent"),
        ...
        ctx.drawString(this.font, Component.literal(reset),
                winX + 18, fy + 9, 0xFFD0D0DA, false);

        ctx.drawString(this.font, Component.literal("Click a row to open the colour picker"),
