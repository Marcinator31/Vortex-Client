...
public final class BlockEspRenderer {
        ...
        LevelRenderEvents.AFTER_TRANSLUCENT_FEATURES.register(context -> {
            ...
            try {
                ...
                for (int i = 0; i < boxes.size(); i++) {
                    ...
                    LevelRenderer.renderLineBox(matrices, lines,
                            box.move(-cam.x, -cam.y, -cam.z), red, green, blue, alpha);
                }
                ...
                if (mod.tracersEnabled() && !boxes.isEmpty()) {
                    ...
                    for (int i = 0; i < boxes.size(); i++) {
                        ...
                        com.mojang.blaze3d.systems.RenderSystem.lineWidth(tw);
                        lines.vertex(mat, (float) sx, (float) sy, (float) sz)
                                .color(sr, sg, sb, sa).normal(nx, ny, nz).endVertex();
    ...
    private static List<AABB> scan(ClientLevel world, BlockEspModule mod,
        ...
        int worldMin = world.getMinBuildHeight();
        int worldMax = world.getMaxBuildHeight();
