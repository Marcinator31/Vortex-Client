...
public final class CrosshairRenderer {
    ...
    public static void draw(GuiGraphics ctx, Minecraft client, CrosshairModule mod) {
     ...
     */
    private static void drawAttackIndicator(GuiGraphics ctx, Minecraft client,
                                            int cx, int cy) {
        try {
    ...
    private static void arm(GuiGraphics ctx, int x, int y, int w, int h,
                            int color, boolean outline) {
        fill(ctx, x, y, w, h, color, outline);
    }

    /** Rectangle, with a dark border around it when asked for. */
    private static void fill(GuiGraphics ctx, int x, int y, int w, int h,
                             int color, boolean outline) {
        if (outline) {
     ...
     */
    private static void circle(GuiGraphics ctx, int cx, int cy, int radius, int th,
                               int color, boolean outline) {
