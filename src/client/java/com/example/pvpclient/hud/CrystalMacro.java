...
public final class CrystalMacro {
    ...
    public static void register() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            ...
            try {
                ...
                com.example.pvpclient.core.Errors.report("CrystalMacro", pvpErr);
            }
                    } finally {
                com.example.pvpclient.core.Profiler.record("CrystalMacro",
    ...
    private static void restoreSlot(MinecraftClient client) {
        ...
        try {
            ...
            com.example.pvpclient.core.Errors.report("CrystalMacro.restoreSlot", pvpErr);
        }
        previousSlot = -1;
    }
}
