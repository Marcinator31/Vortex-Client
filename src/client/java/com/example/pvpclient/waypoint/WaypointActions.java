package com.example.pvpclient.waypoint;
...
public final class WaypointActions {
    ...
    public static void register() {
        ClientTickEvents.END_CLIENT_TICK.register(client -> {
            try {
                ...
                com.example.pvpclient.core.Errors.report("WaypointActions", pvpErr);
            }
        });
    }
    ...
    private static void tick(MinecraftClient client) {
        ...
        if (d && !manageDown) {
            client.setScreen(new com.example.pvpclient.gui.WaypointScreen(null));
        }
        manageDown = d;
    }
    ...
    public static WaypointManager.Waypoint addWaypoint(MinecraftClient client,
                                                       ...
                                                       boolean announce) {
        String dim = com.example.pvpclient.hud.WaypointRenderer.currentWorldKey(client);
    ...
    public static void copyToClipboard(MinecraftClient client,
        ...
        try {
            ...
            com.example.pvpclient.core.Errors.report("WaypointActions.clipboard", pvpErr);
        }
    }
    ...
    private static void info(MinecraftClient client, String msg) {
        ...
        try {
            ...
            com.example.pvpclient.core.Errors.report("WaypointActions.info", pvpErr);
        }
    }
}
